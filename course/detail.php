                    ...
                    <?php while ($related = $related_courses->fetch_assoc()): ?>
                        <div class="related-course">
                            <div class="related-image">
                                <img src="<?php echo !empty($related['cover_image']) ? $related['cover_image'] : 'https://source.unsplash.com/random/300x150/?education'; ?>" alt="<?php echo $related['title']; ?>">
                            </div>
                            <div class="related-content">
                                ...
                                <div class="related-meta">
                                    <span><i class="fas fa-clock"></i> <?php echo $related['duration']; ?>分钟</span>
