...
$sql = "INSERT INTO users (username, password, email, role, status, avatar) 
        VALUES ('$admin_username', '$admin_password', '$admin_email', 'admin', '已审核', '../assets/img/admin.gif')
...
$sql = "INSERT INTO users (username, password, email, role, status, organization_name, organization_intro, avatar) 
        VALUES ('$org_username', '$org_password', '$org_email', 'organization', '已审核', '爱心公益组织', '致力于关爱儿童、老人和弱势群体的非盈利组织', '../assets/img/love_org.gif')
        ON DUPLICATE KEY UPDATE username=username";
...
$sql = "INSERT INTO users (username, password, email, role, status, real_name, points, avatar) 
        VALUES ('$volunteer_username', '$volunteer_password', '$volunteer_email', 'volunteer', '已审核', '张志愿', 100, '../assets/img/volunteer001.gif')
        ON DUPLICATE KEY UPDATE username=username";
...
foreach ($volunteer_data as $v) {
    ...
    $v_avatar = "../assets/img/$v_username.gif";
    
    $sql = "INSERT INTO users (username, password, email, role, status, real_name, phone, gender, birthday, points, avatar) 
            VALUES ('$v_username', '$v_password', '$v_email', 'volunteer', '已审核', '$v_real_name', '$v_phone', '$v_gender', '$v_birthday', $v_points, '$v_avatar')
            ON DUPLICATE KEY UPDATE username=username";
...
foreach ($org_data as $o) {
    ...
    $o_phone = $o[3];
    $o_email = $o[4];
    $o_avatar = "../assets/img/$o_username.gif";
    
    $sql = "INSERT INTO users (username, password, email, role, status, organization_name, organization_intro, phone, avatar) 
            VALUES ('$o_username', '$o_password', '$o_email', 'organization', '已审核', '$o_name', '$o_intro', '$o_phone', '$o_avatar')
            ON DUPLICATE KEY UPDATE username=username";
...
// 创建演示数据 - 项目
$sql = "INSERT INTO projects (title, description, cover_image, organization_id, location, start_date, end_date, quota, registered, status, contact_name, contact_phone, contact_email, video_url) 
        VALUES ('关爱山区儿童公益行', '为山区儿童送去学习用品和关爱，组织志愿者前往山区学校开展支教活动。', 'https://tse3-mm.cn.bing.net/th/id/OIP-C.n9_W8vF53gdnJVxAuX1ZNwHaDe?w=305&h=164&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_id, '四川省阿坝藏族羌族自治州', '2025-06-01', '2025-06-10', 20, 18, '招募中', '李主任', '13800138000', 'project@aixinlianmeng.org', '../assets/img/关爱山区儿童公益行.mp4')
        ";
...
$sql = "INSERT INTO projects (title, description, cover_image, organization_id, location, start_date, end_date, quota, registered, status, contact_name, contact_phone, contact_email) 
        VALUES ('城市环保清洁日', '组织志愿者在城市公园和河畔进行垃圾清理活动，提高市民环保意识。', 'https://tse3-mm.cn.bing.net/th/id/OIP-C.8dwc8Ub0mkZ-dAqA4_4aVwHaHa?w=170&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_id, '北京市海淀区', '2025-05-10', '2025-05-10', 50, 50, '已结束', '王组长', '13900139000', 'project@aixinlianmeng.org')
        ";
...
// 添加更多项目
$project_data = [
    ['社区老人关爱行动', '组织志愿者定期走访社区独居老人，提供生活帮助和情感陪伴', 'https://tse2-mm.cn.bing.net/th/id/OIP-C.arn74QS8NvsGRMF9BLvetAHaDt?w=327&h=175&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_ids['elder_help'], '上海市徐汇区', '2025-05-18', '2025-12-20', 15, 15, '进行中'],
    ['城市河道清洁计划', '定期清理城市河道垃圾，美化水环境', 'https://tse1-mm.cn.bing.net/th/id/OIP-C.R7bAX2jcM5JmXkjDmFlJmgHaE8?w=235&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_ids['green_earth'], '广州市天河区', '2025-05-01', '2025-05-02', 30, 30, '已结束'],
    ['乡村儿童阅读推广', '为乡村学校捐赠图书，并组织志愿者进行阅读指导', 'https://tse1-mm.cn.bing.net/th/id/OIP-C._KnVfN3yau1-YLa1w556lwHaFj?w=244&h=183&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_ids['child_care'], '云南省大理市', '2025-06-10', '2025-06-20', 25, 22, '招募中'],
    ['城市公园植树活动', '在城市公园举行植树活动，改善城市生态环境', 'https://tse4-mm.cn.bing.net/th/id/OIP-C.jXf2V97d3aVy3gLg-6vgYgHaE7?w=243&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_ids['green_earth'], '深圳市南山区', '2025-06-01', '2025-06-01', 40, 0, '待审核'],
    ['特殊儿童关爱日', '为特殊儿童提供一对一陪伴和互动游戏', 'https://tse4-mm.cn.bing.net/th/id/OIP-C.cLlsfI-jyc2zmYETqiamdAHaE7?w=299&h=199&c=7&r=0&o=5&dpr=1.3&pid=1.7', $org_ids['child_care'], '北京市朝阳区', '2025-06-12', '2025-06-12', 20, 0, '待审核']
];
...
foreach ($project_data as $p) {
    ...
    $sql = "INSERT INTO projects (title, description, cover_image, organization_id, location, start_date, end_date, quota, registered, status, contact_name, contact_phone, contact_email) 
            VALUES ('$title', '$description', '$cover_image', $org_id, '$location', '$start_date', '$end_date', $quota, $registered, '$status', '$contact_name', '$contact_phone', '$contact_email')";
...
$sql = "INSERT INTO stories (user_id, project_id, cover_image, title, content, status) 
        VALUES ($volunteer_id, $project_id, 'https://tse3-mm.cn.bing.net/th/id/OIP-C.ktiGtZ0QHam2i7SGOOXYDwHaEh?w=278&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', '我的第一次志愿服务经历', '那天，我和其他几十位志愿者一起来到了北京市海淀区的公园，开始了清理垃圾的活动。虽然天气很热，但看到自己的努力让公园变得更加干净，心里特别有成就感。希望有更多人加入到环保志愿服务中来！', '已审核')
        ";
...
// 添加故事
$story_data = [
    [$volunteer_ids['volunteer002'], $project_ids['城市环保清洁日'],'https://tse4-mm.cn.bing.net/th/id/OIP-C.kOXexSP6fYEcs6l7WIfHJgHaDV?w=303&h=157&c=7&r=0&o=5&dpr=1.3&pid=1.7', '环保志愿者的一天', '参加城市环保清洁日的经历让我深受感动。看到那么多志愿者一起努力，让我们的城市变得更加干净美丽。', '已审核'],
    [$volunteer_ids['volunteer003'], $project_ids['城市河道清洁计划'],'https://tse3-mm.cn.bing.net/th/id/OIP-C.-6aIaBcFvQXejgpyEbdSWgHaFj?w=248&h=186&c=7&r=0&o=5&dpr=1.3&pid=1.7', '守护城市的蓝色血脉', '河道清洁工作虽然辛苦，但看到清澈的河水和市民赞许的目光，一切都值得了。', '已审核'],
    [$volunteer_ids['volunteer004'], $project_ids['社区老人关爱行动'],'https://tse2-mm.cn.bing.net/th/id/OIP-C.f1AEtl-34ofeS7IaXtsi2AHaFj?w=225&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', '与老人们的温暖时光', '陪伴社区老人的过程中，我收获了许多人生智慧，也感受到了人与人之间的真情实意。', '待审核'],
    [$volunteer_ids['volunteer001'], null,'https://tse2-mm.cn.bing.net/th/id/OIP-C.hq1aknX5eNI5lXwtJaBd0AHaE8?w=276&h=184&c=7&r=0&o=5&dpr=1.3&pid=1.7','我的志愿服务之路', '从大学开始参与志愿服务至今，已经有五年时间，每一次服务都是一次成长。', '已审核']
];
...
foreach ($story_data as $s) {
    ...
    $sql = "INSERT INTO stories (user_id, " . ($s[1] ? "project_id, " : "") . "cover_image, title, content, status) 
            VALUES ($user_id, " . ($s[1] ? "$project_id, " : "") . "'$cover_image', '$title', '$content', '$status')";
...
// 添加多媒体
$media_data = [
    [$project_ids['关爱山区儿童公益行'], null, null, 'image', '山区儿童活动照片1', '活动现场照片', 'https://tse3-mm.cn.bing.net/th/id/OIP-C.FbsVLiDGW8c3L2ixVdYacAHaEK?w=300&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7'],
    [$project_ids['关爱山区儿童公益行'], null, null, 'image', '山区儿童活动照片2', '与孩子们的合影', 'https://tse2-mm.cn.bing.net/th/id/OIP-C.TlBRiMUfFMBWwpDa9HINEwHaE8?w=276&h=184&c=7&r=0&o=5&dpr=1.3&pid=1.7'],
    [$project_ids['城市环保清洁日'], null, null, 'image', '环保活动照片', '志愿者清理垃圾', 'https://tse3-mm.cn.bing.net/th/id/OIP-C.bqwpTvIe1jBwc47L1o3nrwHaE8?w=236&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7'],
...
// 添加打卡记录
$checkin_data = [
    [$volunteer_ids['volunteer001'], '2025-05-10'],
    [$volunteer_ids['volunteer001'], '2025-05-11'],
    [$volunteer_ids['volunteer001'], '2025-05-12'],
    [$volunteer_ids['volunteer002'], '2025-05-10'],
    [$volunteer_ids['volunteer002'], '2025-05-12'],
    [$volunteer_ids['volunteer003'], '2025-05-11'],
    [$volunteer_ids['volunteer004'], '2025-05-12']
];
